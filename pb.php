<div class="card" style="padding-top: 10px; padding-left: 10px; padding-right: 10px">
        <a class="text-muted" style="font-family: cursive; font-size: 30px">My Purchased Books</a><hr class="sty">

        			<?php
        			$prod="select * from products where buyer = '$user' order by 1 asc"; //desc
